...
class WheelLoad:
   def __init__(self, filename: str ):
        ...
        self.switch_columns()
        print(self.data)
        #self.convert_voltage_to_mm()
        #self.calculate_consts()
        #self.calculate_force_equations()
        #self.plot_wheel_load_vs_time()
        #self.WR_F = 0.0
        #self.WR_R = 0.0
        #self.WR_Rollf = 0.0
        #self.WR_Rollr = 0.0
   ...
   def calculate_force_equations(self):
        self.data["Force_LF"] = CORNER_WEIGHT_LF + 0.25 * ( self.K_H * ( self.data["Front Left"] + self.data["Front Right"] + self.data["Rear Left"] + self.data["Rear Right"]) + self.K_P * (self.data["Front Left"] + self.data["Front Right"] - self.data["Rear Left"] - self.data["Rear Right"]) + self.K_R * ( self.data["Front Left"] - self.data["Front Right"] + self.data["Rear Left"] - self.data["Rear Right"]) * self.q + self.K_W * ( self.data["Front Left"] - self.data["Front Right"] - self.data["Rear Left"] + self.data["Rear Right"]) * (1 - self.w)) 
        self.data["Force_RF"] = CORNER_WEIGHT_RF + 0.25 * ( self.K_H * ( self.data["Front Left"] + self.data["Front Right"] + self.data["Rear Left"] + self.data["Rear Right"]) + self.K_P * (self.data["Front Left"] + self.data["Front Right"] - self.data["Rear Left"] - self.data["Rear Right"]) - self.K_R * ( self.data["Front Left"] - self.data["Front Right"] + self.data["Rear Left"] - self.data["Rear Right"]) * self.q - self.K_W * ( self.data["Front Left"] - self.data["Front Right"] - self.data["Rear Left"] + self.data["Rear Right"]) * (1 - self.w)) 
        self.data["Force_RR"] = CORNER_WEIGHT_RR + 0.25 * ( self.K_H * ( self.data["Front Left"] + self.data["Front Right"] + self.data["Rear Left"] + self.data["Rear Right"]) - self.K_P * (self.data["Front Left"] + self.data["Front Right"] - self.data["Rear Left"] - self.data["Rear Right"]) + self.K_R * ( self.data["Front Left"] - self.data["Front Right"] + self.data["Rear Left"] - self.data["Rear Right"]) * (1 - self.q) - self.K_W * ( self.data["Front Left"] - self.data["Front Right"] - self.data["Rear Left"] + self.data["Rear Right"]) * self.w)
        self.data["Force_LR"] = CORNER_WEIGHT_RL + 0.25 * ( self.K_H * ( self.data["Front Left"] + self.data["Front Right"] + self.data["Rear Left"] + self.data["Rear Right"]) - self.K_P * (self.data["Front Left"] + self.data["Front Right"] - self.data["Rear Left"] - self.data["Rear Right"]) - self.K_R * ( self.data["Front Left"] - self.data["Front Right"] + self.data["Rear Left"] - self.data["Rear Right"]) * (1 - self.q) + self.K_W * ( self.data["Front Left"] - self.data["Front Right"] - self.data["Rear Left"] + self.data["Rear Right"]) * self.w)
